 ...
 *   px4_ap1_fmu_amber_led.cpp 
 *
 */

#define S_FUNCTION_NAME                px4_ap1_fmu_amber_led
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (!ssSetNumInputPorts(S, 1))
	...
	ssSetInputPortDataType(S, 0, SS_BOOLEAN); // (Datatypes see in sl_types_def.h of Simulink )
